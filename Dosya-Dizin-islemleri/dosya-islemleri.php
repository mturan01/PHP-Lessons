...
#  touch('test.txt');//Dosya oluşturma
#  touch('test2.txt',time());//Dosya oluşturma zamanlı bir şekilde
#  touch('test3.txt',time()-86400);//Dosya oluşturma bir öncesi gün oluşturulmuş gibi

#  unlink('test2.txt');//Dosyayı silme işlemi
